...
OK let's try something really fun now. See if we can add a citation. For now it looks like we can add citations for packages or from a DOI pretty easily. @dplyr here we cited the dplyr package, here is ggplot 2 [@ggplot2].
